...
declare var M: any;
@Component({
  selector: 'app-yoga-dietbetes',
  templateUrl: './yoga-dietbetes.component.html',
  styleUrls: ['./yoga-dietbetes.component.css'],
  providers: [YogaService]
})
export class YogaDietbetesComponent implements OnInit {
