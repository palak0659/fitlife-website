...
declare var M: any;
@Component({
  selector: 'app-supplementgain',
  templateUrl: './supplementgain.component.html',
  styleUrls: ['./supplementgain.component.css'],
  providers: [SupplementService]
})
export class SupplementgainComponent implements OnInit {
