...
declare var M: any;
@Component({
  selector: 'app-bodybuildingform',
  templateUrl: './bodybuildingform.component.html',
  styleUrls: ['./bodybuildingform.component.css'],
  providers: [ BodybuildingService]
})
export class BodybuildingformComponent implements OnInit {
